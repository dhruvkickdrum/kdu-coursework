...
export default function ProductDetails() {
  ...
  if(!id || Number.isNaN(productId)) {
    return <ErrorState message='Invalid product Id.' actionLabel='Back' onAction={handleBack} />
  ...
  const discountedPrice = hasDiscount ? product.price - product.price * (product.discountPercentage / 100) : product.price;
            ...
            {hasDiscount && (
              <>
                <div className="details_price-sub">
                  ...
                  <span className="details_value">{product.discountPercentage}%</span>
                </div>
                <div className="details_price-sub">
                  <span className="details_label">Discounted Price</span>
                  <span className='details_value'>${discountedPrice.toFixed(2)}</span>
                </div>
              </>
            )}
          </div>
